...
export const pages = [
  ...
  { source: 'hydrion/docs/install/index.html', route: '/hydrion/docs/install/', changefreq: 'monthly', priority: '0.70', static: true },
  { source: 'hydrion/docs/getting-started/index.html', route: '/hydrion/docs/getting-started/', changefreq: 'monthly', priority: '0.70', static: true },
  { source: 'hydrion/docs/hydration/index.html', route: '/hydrion/docs/hydration/', changefreq: 'monthly', priority: '0.70', static: true },
  { source: 'hydrion/docs/challenges/index.html', route: '/hydrion/docs/challenges/', changefreq: 'monthly', priority: '0.70', static: true },
  { source: 'hydrion/docs/troubleshooting/index.html', route: '/hydrion/docs/troubleshooting/', changefreq: 'monthly', priority: '0.70', static: true },
  ...
  { source: 'chains.html', route: '/chains/', changefreq: 'yearly', priority: '0.20', sitemap: false },
  { source: 'construction.html', route: '/construction/', changefreq: 'yearly', priority: '0.20', sitemap: false },
...
async function syncCleanRoutes() {
  ...
  const sitemap = [
    ...
    ...pages.filter((page) => page.sitemap !== false).flatMap((page) => [
      '  <url>',
